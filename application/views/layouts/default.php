  ...
  <!-- 
    ...
    <div id="fh5co-header">
        <div class="container">
            ...
            <div id="fh5co-logo">
                <a href="/">Александр Сорокин<span></span></a>
            </div>
    ...
    <div id="fh5co-main">
        ...
        <div id="fh5co-home" class="js-fullheight" data-section="home">
            ...
            <div class="flexslider">
                    ...
                    <div class="container">
                        <div class="row text-center">
                            <h1 class="animate-box">
                                Мы любим рассказывать истории</h1>
                ...
                <ul class="slides">
                   <li style="background-image: url(public/images/slide_2.jpg);" data-stellar-background-ratio="0.5"></li>
                <li style="background-image: url(public/images/slide_1.jpg);" data-stellar-background-ratio="0.5"></li>
                <li style="background-image: url(public/images/slide_3.jpg);" data-stellar-background-ratio="0.5"></li>
...
<script src="public/js/remodal.min.js"></script>
